...
public class SmartConfigActivity extends AppCompatActivity implements OnClickListener {
    ...
    private static final String AES_SECRET_KEY = "9874563211479635"; // TODO modify your own key
    ...
    private IEsptouchListener getEsptouchListener() {
        if (esptouchListener == null) {
            esptouchListener = new IEsptouchListener() {
                @Override
    ...
    private static class EsptouchAsyncTask4 extends AsyncTask<byte[], Void, List<IEsptouchResult>> {
        ...
        protected List<IEsptouchResult> doInBackground(byte[]... params) {
            ...
            synchronized (mLock) {
                ...
                mEsptouchTask.setEsptouchListener(activity.getEsptouchListener());
            }
        ...
        protected void onPostExecute(List<IEsptouchResult> result) {
            ...
            if (!firstResult.isCancelled()) {
                ...
                if (firstResult.isSuc()) {
                    ...
                    mResultDialog.setTitle("Esptouch success");
                    mResultDialog.setMessage(sb.toString());
                }
                else {
                    mResultDialog.setTitle("Error occurred");
